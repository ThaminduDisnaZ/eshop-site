                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="card mx-0 mx-lg-3 my-3" style="max-width: 540px;">
                                            <div class="row g-0">
                                                <div class="col-md-4">
                                                    <img src="resources/mobile_images/vivo_y20.svg" class="img-fluid rounded-start" alt="...">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Vivo Y20</h5>
                                                        <p class="card-text"><b>Seller : </b>Muditha Methsara</p>
                                    ...
                                    <div class="col-12 col-lg-2 text-center text-lg-end">
                                        <label class="form-label fs-5 py-5">01.11.2022 00.00.00</label>
                                    </div>
                                    <div class="col-12 col-lg-3">
                                        <div class="row">
                                            <div class="col-6 d-grid">
                                                <button class="btn btn-secondary border border-1 fs-5 rounded border-primary mt-5" onclick="addFeedback(<?php echo $invoice_data['product_id']; ?>);">
                                                    <i class="bi bi-info-circle-fill fs-5"></i> Feedback</button>
                                            </div>
                                            <div class="col-6 d-grid">
                                                <button class="btn btn-danger fs-5 rounded mt-5">
                                                    <i class="bi bi-trash3-fill fs-5"></i> Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="flexRadioDefault" id="type1" checked>
                                                                    <label class="form-check-label text-primary fw-bold" for="type1">
                                                                        Positive
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="flexRadioDefault" id="type2" checked>
                                                                    <label class="form-check-label text-success fw-bold" for="type2">
                                                                        Neutral
                                                                    </label>
                                                                </div>
                                                            </div>
