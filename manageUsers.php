...
<head>
    ...
    <title>Manage Users | eShop</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewMsgModal('<?php echo $selected_data['email'] ?>');">
                            <img src="resources/profile_image/new user.svg" style="height: 40px;margin-left: 80px;" />
                        </div>
                        <div class="col-4 col-lg-2 bg-primary py-2">
                ...
                <!-- msg model -->
                <div class="modal" tabindex="-1" id="userMsgModel<?php echo $selected_data['email'] ?>">
